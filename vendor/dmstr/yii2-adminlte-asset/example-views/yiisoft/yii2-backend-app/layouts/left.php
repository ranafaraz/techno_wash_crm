            ...
            [
                ...
                'items' => [
                    // ['label' => 'Menus', 'options' => ['class' => 'header center']],
                     ...
                     ['label' => 'Customer', 'icon' => 'arrow-right', 'url' => "./home"],
                     ['label' => 'Employee', 'icon' => 'arrow-right', 'url' => "./home"],
                     ['label' => 'Membership', 'icon' => 'arrow-right', 'url' => "./home"],
                     ['label' => 'Services', 'icon' => 'arrow-right', 'url' => "./home"],
                     [
                        'label' => 'Stock',
                        'icon' => 'arrow-right',
                        'url' => '#',
                        'items' => [
                            ['label' => 'Manage Stock', 'icon' => 'chevron-right', 'url' => './subjects',],
                            ['label' => 'Issue to Employee', 'icon' => 'chevron-right', 'url' => './subjects',],
                        ],
                    ],
                    ['label' => 'Sale Invoice', 'icon' => 'arrow-right', 'url' => "./home"],
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            [
                                ...
                                'url' => '#',
                                'items' => [
                                    ['label' => 'Sub Ctaegory', 'icon' => 'chevron-right', 'url' => './subjects',],
                                ],
                            ],
                            ['label' => 'Card Type', 'icon' => 'caret-right', 'url' => ["/std-sessions"],],
                            [
                                'label' => 'Stock',
                                'icon' => 'caret-right',
                                'url' => '#',
                                'items' => [
                                    ['label' => 'Manufacturer', 'icon' => 'chevron-right', 'url' => './subjects',],
                                    ['label' => 'Stock Type', 'icon' => 'chevron-right', 'url' => './subjects',],
                                ],
                            ],
                            ['label' => 'User Types', 'icon' => 'caret-right', 'url' => ["/std-sections"],],
                            ['label' => 'Employee Type', 'icon' => 'caret-right', 'url' => ["/std-sections"],],
                            [
                                'label' => 'Salary',
                                'icon' => 'caret-right',
                                'url' => '#',
                                'items' => [
                                    ['label' => 'Wage Type', 'icon' => 'chevron-right', 'url' => './subjects',],
                                    ['label' => 'Allowance Type', 'icon' => 'chevron-right', 'url' => './subjects',],
                                ],
                            ],
                            ['label' => 'Vendor', 'icon' => 'caret-right', 'url' => ["/std-sections"],],
                            // [
                            //     'label' => 'Subjects',
                            //     'icon' => 'caret-right',
                            //     'url' => '#',
