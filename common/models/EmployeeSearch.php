...
class EmployeeSearch extends Employee
{
    ...
    public function rules()
    {
        return [
            ...
            [['emp_name', 'emp_cnic', 'emp_father_name', 'emp_email', 'emp_image', 'emp_gender', 'emp_qualification', 'emp_reference', 'joining_date', 'learning_date', 'status', 'created_at', 'updated_at', 'emp_type_id', 'branch_id', 'salary_id', 'emp_contact'], 'safe'],
        ];
    }
