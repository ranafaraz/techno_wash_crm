...
class Stock extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['stock_type_id', 'purchase_invoice_id', 'manufacture_id', 'barcode', 'name', 'purchase_price', 'selling_price', 'status', 'created_by', 'updated_by'], 'required'],
            [['stock_type_id', 'purchase_invoice_id', 'manufacture_id', 'original_price', 'purchase_price', 'selling_price', 'created_by', 'updated_by'], 'integer'],
            [['expiry_date', 'created_at', 'updated_at', 'original_price'], 'safe'],
            [['status'], 'string'],
