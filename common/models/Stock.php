...
class Stock extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['stock_type_id', 'purchase_invoice_id', 'manufacture_id', 'barcode', 'name', 'expiry_date', 'original_price', 'purchase_price', 'selling_price', 'status', 'created_by', 'updated_by'], 'required'],
