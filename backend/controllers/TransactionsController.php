...
class TransactionsController extends Controller
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['logout', 'index', 'create', 'view', 'update', 'delete', 'bulk-delete','branch-details','route-detail-view', 'regular-route-report', 'daily-report', 'date-to-date-report', 'monthly-report', 'yearly-report','load-data','get-banam-data','accounts-report','daily-cashbook','daily-cashbook-data','daily-cashbook-data-receipt','income-statement','income-statement-data','balance-sheet','balance-sheet-data','get-account-rem'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionBalanceSheetData()
    {   
        return $this->renderajax('balance-sheet-data');
    }
    public function actionGetAccountRem()
    {   
        return $this->renderajax('get-account-rem');
    }
    ...
    public function actionDateToDateReport(){
        return $this->render('date-to-date-report');
    }

    public function actionAccountsReport(){
        return $this->render('accounts-report');
    }
