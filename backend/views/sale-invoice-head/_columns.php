        ...
        'value' => function($model, $key, $index, $column) {
            $stdPersonalInfo = Yii::$app->db->createCommand("SELECT customer_name FROM customer
                WHERE customer_id = '$model->customer_id'")->queryAll();
                        ...
                        return Html::a($stdPersonalInfo[0]['customer_name'], [ './sale-invoice-view','sale_invoice_id' => $model->sale_inv_head_id,'customer_id' => $model->customer_id ], ['id' => $model->customer_id , 'target' => '_blank', 'data' => ['pjax' => 0]] );
                    },
