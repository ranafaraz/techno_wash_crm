...
<div class="row">
    <div class="col-md-12">
        <h2 style="text-align: center;font-family:georgia;color:#367FA9;margin-top:0px;">View VehicleType (<b><?php echo $vehicletypeName; ?></b>)</h2>
    </div>
</div>
<div class="vehicle-type-view" style="background-color:#efefef;padding:20px;border-top:3px solid #367FA9;">
