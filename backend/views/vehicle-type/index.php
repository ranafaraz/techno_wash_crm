...
<div class="vehicle-type-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                Html::a('<i class="glyphicon glyphicon-plus"> Create Manufacture</i>', ['./car-manufacture/create'],
                    ['role'=>'modal-remote','title'=> 'Create new Manufacturer','class'=>'btn btn-info']).
                    Html::a('<i class="glyphicon glyphicon-plus"> Create Vehicle Type</i>', ['create'],
