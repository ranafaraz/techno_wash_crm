...
<body>
	<div class="container">
		<div class="row">
			...
			<div class="row">		
			<div class="col-md-12">
			    <h2 style="text-align: center;font-family:georgia;color:#367FA9;margin-top:0px;">Update Customer (<b><?php echo $customerData[0]['customer_name']; ?></b>) Credit Invoice</h2>
			</div>
		</div>
...
<?php 
    ...
    SELECT *
    FROM sale_invoice_head
    WHERE sale_inv_head_id = '$saleinvHeadID' AND (status = 'paid' OR status = 'Paid')
    ")->queryAll();
    $countupdateinvoiceData = count($updateinvoiceData);
...
<body>
	<div class="container">
		<div class="row">
			...
			<div class="row">		
			<div class="col-md-12">
			    <h2 style="text-align: center;font-family:georgia;color:#367FA9;margin-top:0px;">Update Customer (<b><?php echo $customerData[0]['customer_name']; ?></b>) Paid Invoice</h2>
			</div>
		</div>
		<div class="row" style="background-color:#efefef;padding:20px;border-top:3px solid #367FA9;">
			<form action="sale-invoice-view?customer_id=<?php echo $customerid; ?>" method="POST" accept-charset="utf-8">
