...
<div class="row">
    <div class="col-md-12">
        <h2 style="text-align: center;font-family:georgia;color:#FAB61C;margin-top:0px;">View Membership</h2>
    </div>
</div>
<div class="membership-view" style="background-color:#ffe1a3;padding:20px;border-top:4px solid #FAB61C;">
